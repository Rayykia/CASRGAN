...
def create_directories():
    ...
    --- [checkpoints_ | logs] --- [SRCNN | EDSR | DRRN | RDN | CASR | EDSRGAN | RDNGAN | CASRGAN] --- [x2 | x3 | x4]
    --- imgs --- [process | eval] --- [SRCNN | EDSR | DRRN | RDN | CASR | EDSRGAN | RDNGAN | CASRGAN] --- [x2 | x3 | x4]
    """
...
def fit_CNN(
    ...
    Parameters:
        ...
        device (torch.device)                   -- the device to operate
    
    Returns
        epoch_train_time                        -- training time
        epoch_train_loss                        -- training loss
        epoch_psnr                              -- PSNR on validation set
        epoch_ssim                              -- SSIM on validation set
    """
