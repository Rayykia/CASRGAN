"""Set the format of the dataloaders to feed the networks.

The main interface is through function <create_dataloader>

Example:
    >>> from utils.data_utils import create_dataloader
    >>> train_loader, val_loader = create_dataloader(opt)  # opt is from TrainOptions().parse()
"""
